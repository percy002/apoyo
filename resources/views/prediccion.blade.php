      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <button class="btn btn-primary " onclick=" location.href='{{ route('acertados') }}' " type="">Partidos Acertados</button>
              ...
              <button class="btn btn-success " onclick=" location.href='{{ route('arreglar') }}' " type="">arreglar</button>
            
            <input class="form-control mr-sm-2" type="search" placeholder="Search" id="buscar" aria-label="Search">
            
              
          </div>
        </nav>
  </header>
    <table class="table table-dark" id="tabla_partidos">
        <thead>
...
<script>  
    $(document).ready(function(){  
         ...
         function search_table(value){  
              $('#tabla_partidos tr').each(function(){  
                   var found = 'false';  
                   $(this).each(function(){  
